...
public class Game21_Sequencer : MonoBehaviour
{
    ...
    void Start()
    {
        _allNotes = EditorOnFireFileParser.Game21_FileParser.getNotes();
        ...
        wwiseEventIdSong = AkSoundEngine.PostEvent("Game21_Music",
                                                   gameObject,
